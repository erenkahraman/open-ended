...
export const demoQuestions = [
  ...
  },
  {
    ...
    correctAnswer:
      "The water cycle is a continuous process where water evaporates from oceans and land, forms clouds through condensation, and returns to Earth as precipitation in the form of rain or snow.",
    sampleAnswers: [
      {
  ...
  },
  {
    ...
    correctAnswer:
      "Evolution by natural selection is the process where organisms with favorable traits are more likely to survive and reproduce, passing these traits to their offspring, leading to gradual changes in populations over time.",
    sampleAnswers: [
      {
